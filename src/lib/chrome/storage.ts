...
export const getAccentColorValue = () =>
  getFromStorage<string>(ACCENT_COLOR_KEY, DEFAULT_ACCENT_COLOR);

export const setAccentColorValue = (value: string) =>
  setToStorage(ACCENT_COLOR_KEY, value);
